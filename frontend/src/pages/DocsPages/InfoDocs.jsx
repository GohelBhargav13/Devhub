          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col bg-slate-800/30 p-2 rounded-2xl border-r-4 border-r-white border-b-4 border-b-white border-t-2 border-t-white border-l-2 border-l-white ">
                <div className="flex w-full h-full">
                    <img src="../../../public/image1.png" width={600} className="p-4 border-2 border-slate-700/90 rounded-xl hover:animate-pulse hover:border-b-4 hover:border-slate-950/90 hover:cursor-pointer" />
                 ...
                 <div className="flex w-full h-full">
                    ...
                    <img src="../../../public/image.png" width={600} className="p-4 border-2 border-slate-700/90 rounded-xl hover:animate-pulse hover:border-b-4 hover:border-slate-950/90 hover:cursor-pointer" />
                </div>
            </div>
          </div>
      </div>
